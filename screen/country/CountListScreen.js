...
export default function CountListScreen({ navigation }) {
    ...
    return(
        <>
            <Appbar.Header>
                <Appbar.Content title="Country" />
                <Appbar.Action icon="plus-circle" onPress={() => navigation.navigate('CountInsertScreen')} size={26} style={{margin:10}} />
            </Appbar.Header>
                ...
                <FlatList
                    ...
                    renderItem={({item}) => 
                        <List.Item
                            ...
                            onPress={() => navigation.navigate('CountUpdateScreen', {id:item.id})}
                        />
                    }
